...
// ... (all the rest of your code, including TestimonialCard, FeatureListItem, AppStoreButton, and WhyUsPage)

// At the end of the file, just make sure the export is default:
...
export default function WhyUsPage() {
    ...
    return (
        <div className="bg-[#f4f4f4] font-sans">
