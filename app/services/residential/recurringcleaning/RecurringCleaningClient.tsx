...
interface RecurringCleaningClientProps {
  faqData: IFaq[];
  checklistData: IChecklist;
}

// Your component now accepts data as props
export default function RecurringCleaningClient({ faqData, checklistData }: RecurringCleaningClientProps) {
    ...
    <div className="w-full p-4 md:p-8">
      ...
      <div className="pt-8">
        <div className="max-w-2xl">
          {/* Corrected this title for you */}
          <h2 className="text-2xl font-bold mb-8">Recurring Cleaning Checklist</h2>
