...
interface OneTimeCleaningClientProps {
  faqData: IFaq[];
  checklistData: IChecklist;
}

// Your component now accepts data as props
export default function OneTimeCleaningClient({ faqData, checklistData }: OneTimeCleaningClientProps) {
  ...
  return (
    <div className="w-full p-4 md:p-8">
      ...
      {/* Checklist Section - I've updated the title to match */}
      <div className="pt-8">
        <div className="max-w-2xl">
          <h2 className="text-2xl font-bold mb-8">One-Time Cleaning Checklist</h2>
