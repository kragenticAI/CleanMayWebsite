// DeepCleaningClient.tsx
"use client"; // This file remains a Client Component
...
interface DeepCleaningClientProps {
  faqData: IFaq[];
  checklistData: IChecklist;
}

// Your component now accepts props
export default function DeepCleaningClient({ faqData, checklistData }: DeepCleaningClientProps) {
  ...
  return (
    <div className="w-full p-4 md:p-8">
      ...
      <div className="mb-8 flex flex-col items-start justify-between md:flex-row md:items-center">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 md:mb-0">Deep Cleaning</h1>
      ...
      <div className="pt-8">
        <div className="">
          <h2 className="text-2xl font-bold mb-8">Deep Cleaning Checklist</h2>
      ...
      <div className="container ">
       ...
       <EstimateFilloutForm>
        ...
        <h2 className="text-[30px] font-bold mt-[15px]">REQUEST AN ESTIMATE FOR  DEEP CLEANING</h2>
      </EstimateFilloutForm>
    </div>
  );
}