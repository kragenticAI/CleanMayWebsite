...
export const metadata: Metadata = {
  title: 'Inventory Cleaning ',
};


// 3. This is your page component
const InventoryCleaning: React.FC = () => {
  return (
    ...
    <>
      ...
      <EstimateFilloutForm>
        <h1 className="text-[40px] font-semibold">Inventory Cleaning</h1>
        <h2 className="text-[20px] font-bold mt-[15px]">REQUEST AN ESTIMATE FOR INVENTORY CLEANING</h2>
      </EstimateFilloutForm>
    </>
  );
};

export default InventoryCleaning;