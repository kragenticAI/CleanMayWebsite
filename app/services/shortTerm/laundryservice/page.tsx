...
const LaundryServie: React.FC = () => {
  return (
    ...
    <>
      ...
      <EstimateFilloutForm>
        <h1 className="text-[40px] font-semibold">Laundry Service</h1>
        <h2 className="text-[20px] font-bold mt-[15px]">REQUEST AN ESTIMATE FOR LAUNDRY SERVICE</h2>
      </EstimateFilloutForm>
    </>
  );
};

export default LaundryServie;