...
// 3. Define your JSON-LD Schema (Updated for Recurring Cleaning)
const recurringCleaningSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Recurring Cleaning',
  name: 'Recurring Cleaning Service (Weekly, Bi-Weekly, Monthly)',
  description: 'Maintain a consistently clean home with our recurring cleaning services. Flexible scheduling (weekly, bi-weekly, monthly) with discounts available.',
  provider: {
    '@type': 'Organization',
    name: 'Clean May'
  },
  // !! UPDATE THIS URL to the correct final URL
  url: 'https://www.yourwebsite.com/service/residential/recurringcleaning',
  mainEntity: {
    '@type': 'FAQPage',
