...
// 3. Define your JSON-LD Schema (Updated for Post-Construction Cleaning)
const postConstructionSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  serviceType: 'Post-Construction Cleaning',
  name: 'Post-Construction / Renovation Cleaning',
  description: 'Specialized cleaning service to remove fine dust, debris, and residue after a renovation or new build, making your space move-in ready.',
  provider: {
    '@type': 'Organization',
    name: 'Clean May'
  },
  // !! UPDATE THIS URL to the correct final URL
  url: 'https://www.yourwebsite.com/service/residential/postconstructioncleaning',
  mainEntity: {
    '@type': 'FAQPage',
